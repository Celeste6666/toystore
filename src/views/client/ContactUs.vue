    ...
    <section class="card">
      <div class="card-body p-6">
        <div class="row g-5">
          ...
          <div
            class="col-1 col-md-7 d-flex flex-column justify-content-start align-content-between"
          >
            ...
            <div class="mb-3">
              ...
              <textarea
                class="form-control border border-2 rounded w-75 px-4 py-2"
                rows="3"
              >
              </textarea>
              <div class="mt-3">
                <button class="btn btn-danger rounded-pill py-2 px-4 mt-3">
                  送出訊息
                </button>
              </div>
            </div>
          ...
          <div class="col-1 col-md-5">
            ...
            <p class="mb-3 lh-lg">
              ...
              <a
                href="#"
                class="text-decoration-none text-dark border-bottom border-2 p-2 contact-link"
            ...
            <div class="mt-5">
              ...
              <div>
                <a href="#" class="btn btn-info rounded-circle contact-icon p-2 me-2"
                  ><i class="bi bi-twitter text-white"></i
                ></a>
                <a
                  href="#"
                  class="btn rounded-circle contact-icon p-2 me-2"
                ...
                <a
                  href="#"
                  class="btn btn-info rounded-circle contact-icon p-2 me-2"
