  ...
  <div class="products">
    ...
    <section>
        ...
        >
          <div class="card-body d-flex align-items-center justify-content-around">
            ...
            <span class="text-start">
              {{ product.title }}<br />
              <span class="badge rounded-pill bg-success small product-type">{{
                product.category
              }}</span>
            </span>
            ...
            <div class="product-edit">
              ...
              <button class="btn fs-4" :data-id="product.id" @click.prevent="delete">
                <i class="bi bi-trash" :data-id="product.id" @click.prevent="delete"></i>
              </button>
            </div>
          </div>
        </li>
      ...
      <button
        ...
        data-bs-target="#productModal"
      >
        <i class="bi bi-plus-lg" data-id="add" @click.prevent="setProductId"></i>
        新增產品
      </button>
    </section>
